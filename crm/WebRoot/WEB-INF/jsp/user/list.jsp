  ...
  <html:form action="user">
  	...
  	<span style="font-weight:bold;">查询条件</span>
		...
		<tr>
			...
			<td class="data_title" style="width:50%;" onclick="order_by('usrName');">用户名</td>
		...
		<logic:iterate id="item" name="userForm" property="pageResult.list"
			...
			<tr>
				...
				<td class="data_cell">
					<button class="op_button" onclick="window.location.href='?o=toDetail&id=${item.usrId }'" style="width:40px;">查看</button>
					<button class="op_button" onclick="window.location.href='?o=toEdit&id=${item.usrId }'" style="width:40px;">编辑</button>
					<button class="op_button" onclick="doDel('id=${item.usrId }','doDel')" style="width:40px;">删除</button>
				</td>
			</tr>
		</logic:iterate>
