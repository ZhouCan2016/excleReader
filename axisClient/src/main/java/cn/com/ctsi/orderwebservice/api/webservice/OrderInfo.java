            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"orderInfo".equals(type)){
                                ...
                                return (OrderInfo)cn.com.ctsi.orderwebservice.api.webservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://webService.api.orderWebService.ctsi.com.cn","xml").equals(reader.getName()) || new javax.xml.namespace.QName("","xml").equals(reader.getName()) ){
